                      ...
                      <form className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex">
                              <Smartphone className="h-4 w-4 text-muted-foreground absolute mt-3 ml-3" />
                              <Input 
                                id="phone" 
                      ...
                      <div className="space-y-6">
                        ...
                        <div>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="font-medium">Device authorization</p>
                                <p className="text-sm text-muted-foreground">Require authorization for new devices</p>
                              </div>
                              <Switch defaultChecked />
                            </div>
                          </div>
                        ...
                        <div>
                          ...
                          <div className="space-y-4">
                            <div className="flex items-center justify-between">
                              ...
                              <Switch checked={notificationSettings.assignmentReminders} 
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">Receive updates about behavior and performance</p>
                              </div>
                              <Switch checked={notificationSettings.behavioralUpdates} 
                                onCheckedChange={(value) => handleNotificationChange('behavioralUpdates', value)} 
                              />
                            </div>
                            <div className="flex items-center justify-between">
                              <div>
                                <p className="font-medium">Attendance Alerts</p>
                                <p className="text-sm text-muted-foreground">Get alerts about attendance issues</p>
                              </div>
                              <Switch checked={notificationSettings.attendanceAlerts} 
                            ...
                            <div className="flex items-center justify-between">
                              <div>
                                ...
                                <p className="text-sm text-muted-foreground">Receive general news and announcements</p>
                              </div>
                              <Switch checked={notificationSettings.newsAndAnnouncements} 
                                onCheckedChange={(value) => handleNotificationChange('newsAndAnnouncements', value)} 
                              />
                            </div>
                          </div>
                        </div>
